  ...
  return (
    <div className="min-h-screen bg-black text-white py-12 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="mb-4">
          L'utilisateur doit consulter la page <Link href="/confidentialite" className="text-yellow-400 underline">Politique de confidentialité</Link> pour connaître l’usage de ses données.
        </p>
